...
def findObjects(outputs,img): 
    ...
    for i in indices:
        ...
        cv2.rectangle(img,(x,y),(x+w,y+h),(0,0,255),2) #BGR color format
        ...
        #cv2.putText(img,f'FPS:{int(net.GetNetworkFPS())}', (30,30),cv2.FONT_HERSHEY_SIMPLEX,1,(255,0,0),2) #(30,30) denotes position
...
while True:
    ...
    if cv2.waitKey(10) & 0xFF == ord('q'):#checking every 10ms
        break
